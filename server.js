...
// 1. Verificar si el admin ya fue creado
app.get('/api/verificar-admin', (req, res) => {
    const creado = fs.existsSync(ADMIN_FILE);
    res.json({ creado });
});

// 2. Crear las credenciales iniciales por primera vez
...
// 3. Procesar el inicio de sesión
...
// 4. Actualizar credenciales de acceso
